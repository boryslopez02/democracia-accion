...
class MembersComiteStoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'seccional.exists' => 'La seccional seleccionada no es válida.',
            'municipio.exists' => 'El municipio seleccionado no es válido.',
            'parroquia.exists' => 'La parroquia seleccionada no es válida.',
    ...
    public function rules()
    {
        return [
            ...
            'seccional' => 'required|exists:seccionales,id',
